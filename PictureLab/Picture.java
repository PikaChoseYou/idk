...
public class Picture extends SimplePicture 
{
  ...
  /**Method that keeps only the blue values, 
  ...
  /**Method that negates all the pixels
  ...
  /**Method that modifies pixel colors to make water easier to see through  */
...
/** Method that mirrors a square part of a picture 
...
public void mirrorDiagonal()
{
  ...
  /** Mirror just part of a picture of a beach to have 2 seagulls
  ...
  /** copy from the passed fromPic of specified
   ...
   * @param startCol the start col to copy to
   */
 public void copy(Picture fromPic, int fromStartRow, int fromEndRow,
		 int fromStartCol, int fromEndCol, int startRow, int startCol)
 {
  ...
  {
	  //Picture fromPic, int fromStartRow, int fromEndRow,
		 //int fromStartCol, int fromEndCol, int startRow, int startCol)
  ...
  public static void main(String[] args) 
  {
   ...
   DigitalPicture i = new SimplePicture();
    DigitalPicture a = new Picture();
    SimplePicture b = new Picture();  
  }
